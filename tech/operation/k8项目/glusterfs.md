...
heketi-cli -s $HEKETI_CLI_SERVER --user admin topology load --json=/etc/heketi/topology.json cluster create

heketi-cli  -s $HEKETI_CLI_SERVER --user admin volume delete 56bdb70e767d15269478adec12c29e17
...
# gluster volume delete <VOLNAME>
 ...
 建立卷
heketi-cli volume create --size=6000 --replica=2
